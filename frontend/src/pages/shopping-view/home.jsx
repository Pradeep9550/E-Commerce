...
import {  AirplayIcon, BabyIcon, ChevronLeftIcon, ChevronRightIcon, CloudLightning, Heater, Images, Shirt, ShirtIcon, ShoppingBasket, UmbrellaIcon, WashingMachine, WatchIcon } from 'lucide-react';
...
function ShoppingHome() {
    ...
    const slides = [bannerOne, bannerTwo, bannerThree];       //slides replace by featureImaeList
    ...
    return ( 
        <div className="flex flex-col min-h-screen">
            <div className="relative m-2 w-full h-[200px] sm:h-[350px] md:h-[450px] lg:h-[600px] overflow-hidden   rounded-t-lg">
          ...
          ? featureImageList.map((slide, index) => (
              <img
                ...
                } absolute top-0 left-0 w-full h-[200px] sm:h-[350px] md:h-[450px] lg:h-[600px]  transition-opacity duration-1000`}
              />
            ))
          : null}
                <Button 
